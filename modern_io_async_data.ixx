...
// Asynchrone DataOutputStream (separate Modul)
export
...
public:
    ...
    // Forwarder: einfache Operationen geben den unterliegenden Awaiter zurück
    ...
    // Mehrschritt-Operation: echte Coroutine
