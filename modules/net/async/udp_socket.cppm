...
private:
    ...
    sockaddr_storage peer_{}; // target address for send()
    socklen_t peer_len_{0};   // length of the target address
...
public:
    ...
    // UDP connect sets the default target address for send/recv
    ...
    // Helper functions for async read/write in the GenericAwaiter style
    ...
    using modern::net::AsyncUdpSocket;
