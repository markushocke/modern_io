...
function(modern_io_resolve_runtime_target out_target)
  ...
  if(MODERN_RUNTIME_PROVIDER STREQUAL "package")
    find_package(modern_runtime CONFIG REQUIRED)
  elseif(MODERN_RUNTIME_PROVIDER STREQUAL "local")
    if(NOT DEFINED MODERN_RUNTIME_ROOT OR MODERN_RUNTIME_ROOT STREQUAL "")
    ...
    if(NOT DEFINED MODERN_RUNTIME_BINARY_DIR OR MODERN_RUNTIME_BINARY_DIR STREQUAL "")
      set(MODERN_RUNTIME_BINARY_DIR "${CMAKE_CURRENT_BINARY_DIR}/modern_runtime")
    endif()
  ...
  elseif(MODERN_RUNTIME_PROVIDER STREQUAL "fetch")
    if(NOT DEFINED MODERN_RUNTIME_GIT_REPOSITORY OR MODERN_RUNTIME_GIT_REPOSITORY STREQUAL "")
    ...
    message(FATAL_ERROR "Unsupported MODERN_RUNTIME_PROVIDER=${MODERN_RUNTIME_PROVIDER}. Expected one of: package, local, fetch")
  endif()
  ...
  elseif(TARGET modern_runtime)
    ...
    message(FATAL_ERROR "modern_runtime provider '${MODERN_RUNTIME_PROVIDER}' did not create target modern_runtime::modern_runtime or modern_runtime")
  endif()
